                ...
                <script>
                			...
                			success:function(response){
                				...
                				list.forEach(function(item){
	                				...
	                				communitySearch(pi);													
													...
													$("#postsTableBody").html("<tr><td colspan='6'>검색한 결과가 없습니다.</td></tr>");
												}
                	...
                	$(document).on("click", ".detail", function(){
                		...
                		if(loginUserNo == writerNo){
	                		location.href="${contextPath}/community/detail.page?postNo=" + postNo + "&postType=G";                			
                		}else{
                			//redirect로 다시 detail
                			location.href="${contextPath}/community/increase.do?postNo=" + postNo + "&postType=G"; 
                		}
                 })
                        ...
                        <c:choose>
                            <c:when test="${ not empty list }">
                                <c:forEach var="list" items="${ list }">
                                    <tr onclick="location.href='${contextPath}/community/${ loginUser.userNo == list.writerNo ?  'detail.page' : 'increase.do' }?postNo=${ list.postNo }&postType=${type}'">
...
$(document).ready(function(){
	...
	if(userType == "M"){
		$("#wirterManager").css("display", "block");
	}
})
...
function writer(){
	if("${loginUser}" == ""){
		...
		location.href="${contextPath}/community/writerForm.page?type=G";			
	}
}
</script>
