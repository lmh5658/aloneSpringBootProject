...
<body>
    <div class="container" style="max-width: 1233px;">
        ...
        <div style="width: 80%;">
        		<div style="text-align: center;font-size: 35px;">강아지</div>
 ...
 function loadListPage(page){
	 $.ajax({
	        url: "${contextpath}/product/ajaxDogProductList.do",
	        type: "get",
	        data: {page:page},
	        success: function(response) {
	            let list = response.list;
 ...
 $(document).on("change", "input[type='checkbox']", function() {
	    ...
	    filterSearch(weight, size, functional, price, rating, 1);
	    
	});

 
 
 function filterSearch(weight, size, functional, price, rating, page) {
	    $.ajax({
	        ...
	        success: function(response) {
	            ...
	            $("#productes").html(html);
	            dogProductPagination(weight, size, functional, price, rating, pi);
 ...
 function dogProductPagination(weight, size, functional, price, rating, pi) {
	    var html = '';
